...
CREATE TABLE chores (id SERIAL PRIMARY KEY, description TEXT, responsible_id INTEGER REFERENCES users, minutes INTEGER, status_id INTEG
ER REFERENCES statuses, category_id INTEGER REFERENCES categories);
